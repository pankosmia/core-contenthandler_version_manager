        ...
        <Button
          ...
          onClick={async () => {
            ...
            if (!copyResponse.ok) {
              enqueueSnackbar(
                doI18n(
                  "pages:content:could_not_copy_repo_to_updates",
                  i18nRef.current,
                ),
                { variant: "error" },
              );
            ...
            const pull1Response = await postEmptyJson(
              pull1Url,
              debugRef.current,
            );
            if (!pull1Response.ok) {
              enqueueSnackbar(
                doI18n(
                  "pages:content:could_not_pull_to_update",
                  i18nRef.current,
                ),
                { variant: "error" },
              );
            ...
            const pull2Response = await postEmptyJson(
              pull2Url,
              debugRef.current,
            );
            if (!pull2Response.ok) {
              enqueueSnackbar(
                doI18n(
                  "pages:content:could_not_pull_to_local",
                  i18nRef.current,
                ),
                { variant: "error" },
              );
