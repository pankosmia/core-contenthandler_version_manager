    ...
    <Box sx={{ height: "70vh" }}>
          ...
          >
            <Box sx={{ width: "100%" }}>
              {status.length > 0 ? (
                <TableContainer
                  component={Paper}
                  sx={{ maxHeight: { sm: 70, md: 110, lg: 160, xl: 200 } }}
                >
                  <Table
                    stickyHeader
                    sx={{ minWidth: "100%" }}
                    size="small"
                    aria-label="status dense table"
                  >
                    <TableHead>
                      <TableRow>
                        {statusColumns.map((s, n) => {
                          return (
                            <TableCell align="left">{s.headerName}</TableCell>
                          );
                        })}
                      </TableRow>
                    </TableHead>
            ...
            <Box sx={{ width: "100%" }}>
              <TextField
                ...
                helperText={doI18n(
                  "pages:content:commit_helper_text",
                  i18nRef.current,
                )}
          ...
          >
            <Box sx={{ width: "100%" }}>
              {commits.length > 0 ? (
                <Paper sx={{ width: "100%", overflow: "hidden" }}>
                  <TableContainer
                    sx={{ maxHeight: { sm: 140, md: 170, lg: 200, xl: 250 } }}
                  >
                    <Table
                      stickyHeader
                      aria-label="commits sticky table"
            ...
            <Box sx={{ width: "100%" }}>
              {remotes.length === 0 && (
                ...
                >
                  {doI18n(
                    "pages:content:add_remote_repo_to_update",
                    i18nRef.current,
                  )}
                </Link>
              )}
              <Tooltip
                title={
                  !enabledRef.current
                    ? doI18n(
                        "pages:content:operation_requires_internet",
                        i18nRef.current,
                      )
      ...
      >
        ...
        <DialogActions>
          <Button
            color="warning"
            onClick={() => setUpdateAnywaysAnchorEl(null)}
          >
          ...
          >
            {doI18n("pages:content:update_anyways", i18nRef.current)}
          </Button>
        </DialogActions>
      </Dialog>
    </Box>
